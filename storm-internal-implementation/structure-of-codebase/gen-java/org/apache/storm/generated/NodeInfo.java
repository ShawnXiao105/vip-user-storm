            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                for (int _i611 = 0; _i611 < _set610.size; ++_i611)
                {
                  long _elem612; // required
                  _elem612 = iprot.readI64();
                  struct.port.add(_elem612);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.setNodeIsSet(true);
      {
        ...
        for (int _i616 = 0; _i616 < _set615.size; ++_i616)
        {
          long _elem617; // required
          _elem617 = iprot.readI64();
          struct.port.add(_elem617);
        }
      }
      struct.setPortIsSet(true);
    }
