...
public class ErrorInfo implements org.apache.thrift.TBase<ErrorInfo, ErrorInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.HOST,_Fields.PORT};
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ERROR_TIME_SECS:
      return Integer.valueOf(getError_time_secs());
  ...
  public int compareTo(ErrorInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetError_time_secs()).compareTo(typedOther.isSetError_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
