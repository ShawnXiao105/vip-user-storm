...
public class ComponentAggregateStats implements org.apache.thrift.TBase<ComponentAggregateStats, ComponentAggregateStats._Fields>, java.io.Serializable, Cloneable {
   ...
   * @see ComponentType
   */
  public ComponentType type; // required
  public CommonAggregateStats common_stats; // required
  public SpecificAggregateStats specific_stats; // required
  public ErrorInfo last_error; // required
  ...
  private _Fields optionals[] = {_Fields.TYPE,_Fields.COMMON_STATS,_Fields.SPECIFIC_STATS,_Fields.LAST_ERROR};
  ...
  public int compareTo(ComponentAggregateStats other) {
    ...
    ComponentAggregateStats typedOther = (ComponentAggregateStats)other;
    ...
    lastComparison = Boolean.valueOf(isSetCommon_stats()).compareTo(typedOther.isSetCommon_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCommon_stats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.common_stats, typedOther.common_stats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSpecific_stats()).compareTo(typedOther.isSetSpecific_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpecific_stats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.specific_stats, typedOther.specific_stats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLast_error()).compareTo(typedOther.isSetLast_error());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLast_error()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = ComponentType.findByValue(iprot.readI32());
