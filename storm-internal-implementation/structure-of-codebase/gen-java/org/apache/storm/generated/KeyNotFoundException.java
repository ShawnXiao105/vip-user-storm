...
public class KeyNotFoundException extends Exception implements org.apache.thrift.TBase<KeyNotFoundException, KeyNotFoundException._Fields>, java.io.Serializable, Cloneable {
  ...
  public KeyNotFoundException setMsg(String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public int compareTo(KeyNotFoundException other) {
    ...
    KeyNotFoundException typedOther = (KeyNotFoundException)other;
