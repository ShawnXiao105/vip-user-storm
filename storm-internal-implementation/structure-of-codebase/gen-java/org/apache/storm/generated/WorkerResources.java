...
public class WorkerResources implements org.apache.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable {
  ...
  public double mem_on_heap; // required
  public double mem_off_heap; // required
  ...
  private _Fields optionals[] = {_Fields.MEM_ON_HEAP,_Fields.MEM_OFF_HEAP,_Fields.CPU};
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case MEM_ON_HEAP:
      return Double.valueOf(getMem_on_heap());

    case MEM_OFF_HEAP:
      return Double.valueOf(getMem_off_heap());
  ...
  public int compareTo(WorkerResources other) {
    ...
    WorkerResources typedOther = (WorkerResources)other;

    lastComparison = Boolean.valueOf(isSetMem_on_heap()).compareTo(typedOther.isSetMem_on_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMem_on_heap()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mem_on_heap, typedOther.mem_on_heap);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMem_off_heap()).compareTo(typedOther.isSetMem_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMem_off_heap()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mem_off_heap, typedOther.mem_off_heap);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
