...
public class HBPulse implements org.apache.thrift.TBase<HBPulse, HBPulse._Fields>, java.io.Serializable, Cloneable {
...
;
  ...
  public HBPulse setDetails(byte[] details) {
    setDetails(details == null ? (ByteBuffer)null : ByteBuffer.wrap(details));
    return this;
  }
  ...
  public int compareTo(HBPulse other) {
    ...
    HBPulse typedOther = (HBPulse)other;
