...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public String assignment_id; // required
  public List<Long> used_ports; // required
  public List<Long> meta; // required
  public Map<String,String> scheduler_meta; // required
  public long uptime_secs; // required
  ...
  private _Fields optionals[] = {_Fields.ASSIGNMENT_ID,_Fields.USED_PORTS,_Fields.META,_Fields.SCHEDULER_META,_Fields.UPTIME_SECS,_Fields.VERSION,_Fields.RESOURCES_MAP};
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case TIME_SECS:
      return Long.valueOf(getTime_secs());
    ...
    case UPTIME_SECS:
      return Long.valueOf(getUptime_secs());
  ...
  public int compareTo(SupervisorInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetAssignment_id()).compareTo(typedOther.isSetAssignment_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetUsed_ports()).compareTo(typedOther.isSetUsed_ports());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUsed_ports()) {
    ...
    lastComparison = Boolean.valueOf(isSetScheduler_meta()).compareTo(typedOther.isSetScheduler_meta());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  long _elem576; // required
                  _elem576 = iprot.readI64();
                  struct.used_ports.add(_elem576);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  long _elem579; // required
                  _elem579 = iprot.readI64();
                  struct.meta.add(_elem579);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i581 = 0; _i581 < _map580.size; ++_i581)
                {
                  ...
                  struct.scheduler_meta.put(_key582, _val583);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i585 = 0; _i585 < _map584.size; ++_i585)
                {
                  ...
                  struct.resources_map.put(_key586, _val587);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            long _elem598; // required
            _elem598 = iprot.readI64();
            struct.used_ports.add(_elem598);
          }
        }
        struct.setUsed_portsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          {
            long _elem601; // required
            _elem601 = iprot.readI64();
            struct.meta.add(_elem601);
          }
        }
        struct.setMetaIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          for (int _i603 = 0; _i603 < _map602.size; ++_i603)
          {
            String _key604; // required
            String _val605; // required
            _key604 = iprot.readString();
            _val605 = iprot.readString();
            struct.scheduler_meta.put(_key604, _val605);
          }
        }
        struct.setScheduler_metaIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          for (int _i607 = 0; _i607 < _map606.size; ++_i607)
          {
            String _key608; // required
            double _val609; // required
            _key608 = iprot.readString();
            _val609 = iprot.readDouble();
            struct.resources_map.put(_key608, _val609);
          }
        }
        struct.setResources_mapIsSet(true);
      }
