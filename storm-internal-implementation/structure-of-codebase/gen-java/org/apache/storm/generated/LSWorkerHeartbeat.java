...
public class LSWorkerHeartbeat implements org.apache.thrift.TBase<LSWorkerHeartbeat, LSWorkerHeartbeat._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(LSWorkerHeartbeat other) {
    ...
    LSWorkerHeartbeat typedOther = (LSWorkerHeartbeat)other;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  ExecutorInfo _elem744; // required
                  _elem744 = new ExecutorInfo();
                  _elem744.read(iprot);
                  struct.executors.add(_elem744);
                }
                iprot.readListEnd();
              }
  ...
  private static class LSWorkerHeartbeatTupleScheme extends TupleScheme<LSWorkerHeartbeat> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.setTopology_idIsSet(true);
      {
        ...
        {
          ExecutorInfo _elem749; // required
          _elem749 = new ExecutorInfo();
          _elem749.read(iprot);
          struct.executors.add(_elem749);
        }
      }
      struct.setExecutorsIsSet(true);
      struct.port = iprot.readI32();
