...
public class DebugOptions implements org.apache.thrift.TBase<DebugOptions, DebugOptions._Fields>, java.io.Serializable, Cloneable {
  ...
  public double samplingpct; // required
  ...
  private _Fields optionals[] = {_Fields.ENABLE,_Fields.SAMPLINGPCT};
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SAMPLINGPCT:
      return Double.valueOf(getSamplingpct());
  ...
  public int compareTo(DebugOptions other) {
    ...
    DebugOptions typedOther = (DebugOptions)other;
    ...
    lastComparison = Boolean.valueOf(isSetSamplingpct()).compareTo(typedOther.isSetSamplingpct());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSamplingpct()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.samplingpct, typedOther.samplingpct);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
