...
public class StreamInfo implements org.apache.thrift.TBase<StreamInfo, StreamInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<String> output_fields; // required
  ...
  public java.util.Iterator<String> getOutput_fieldsIterator() {
    return (this.output_fields == null) ? null : this.output_fields.iterator();
  }

  public void addToOutput_fields(String elem) {
  ...
  public StreamInfo setOutput_fields(List<String> output_fields) {
    this.output_fields = output_fields;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OUTPUT_FIELDS:
      if (value == null) {
        ...
        setOutput_fields((List<String>)value);
      }
      break;
  ...
  public int compareTo(StreamInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetOutput_fields()).compareTo(typedOther.isSetOutput_fields());
    if (lastComparison != 0) {
