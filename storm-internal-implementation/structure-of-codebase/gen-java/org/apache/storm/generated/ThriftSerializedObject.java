...
public class ThriftSerializedObject implements org.apache.thrift.TBase<ThriftSerializedObject, ThriftSerializedObject._Fields>, java.io.Serializable, Cloneable {
  ...
  public ByteBuffer bits; // required
...
;
  ...
  public ThriftSerializedObject setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public ByteBuffer bufferForBits() {
    return bits;
  }

  public ThriftSerializedObject setBits(byte[] bits) {
    setBits(bits == null ? (ByteBuffer)null : ByteBuffer.wrap(bits));
    return this;
  }

  public ThriftSerializedObject setBits(ByteBuffer bits) {
    this.bits = bits;
    return this;
  }
  ...
  public int compareTo(ThriftSerializedObject other) {
    ...
    ThriftSerializedObject typedOther = (ThriftSerializedObject)other;
    ...
    lastComparison = Boolean.valueOf(isSetBits()).compareTo(typedOther.isSetBits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBits()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bits, typedOther.bits);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
