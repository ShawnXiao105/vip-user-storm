...
public class ClusterWorkerHeartbeat implements org.apache.thrift.TBase<ClusterWorkerHeartbeat, ClusterWorkerHeartbeat._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(ClusterWorkerHeartbeat other) {
    ...
    ClusterWorkerHeartbeat typedOther = (ClusterWorkerHeartbeat)other;

    lastComparison = Boolean.valueOf(isSetStorm_id()).compareTo(typedOther.isSetStorm_id());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetExecutor_stats()).compareTo(typedOther.isSetExecutor_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  ExecutorInfo _key696; // required
                  ExecutorStats _val697; // required
                  _key696 = new ExecutorInfo();
                  _key696.read(iprot);
                  _val697 = new ExecutorStats();
                  _val697.read(iprot);
                  struct.executor_stats.put(_key696, _val697);
                }
                iprot.readMapEnd();
              }
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.setStorm_idIsSet(true);
      {
        ...
        {
          ExecutorInfo _key702; // required
          ExecutorStats _val703; // required
          _key702 = new ExecutorInfo();
          _key702.read(iprot);
          _val703 = new ExecutorStats();
          _val703.read(iprot);
          struct.executor_stats.put(_key702, _val703);
        }
      }
      struct.setExecutor_statsIsSet(true);
      struct.time_secs = iprot.readI32();
