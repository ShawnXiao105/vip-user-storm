...
public class SpoutAggregateStats implements org.apache.thrift.TBase<SpoutAggregateStats, SpoutAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public double complete_latency_ms; // required
  ...
  private _Fields optionals[] = {_Fields.COMPLETE_LATENCY_MS};
  ...
  public void unsetComplete_latency_ms() {
    __isset_bit_vector.clear(__COMPLETE_LATENCY_MS_ISSET_ID);
  }
  ...
  public boolean isSetComplete_latency_ms() {
    return __isset_bit_vector.get(__COMPLETE_LATENCY_MS_ISSET_ID);
  }

  public void setComplete_latency_msIsSet(boolean value) {
    __isset_bit_vector.set(__COMPLETE_LATENCY_MS_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case COMPLETE_LATENCY_MS:
      return Double.valueOf(getComplete_latency_ms());
  ...
  public int compareTo(SpoutAggregateStats other) {
    ...
    SpoutAggregateStats typedOther = (SpoutAggregateStats)other;

    lastComparison = Boolean.valueOf(isSetComplete_latency_ms()).compareTo(typedOther.isSetComplete_latency_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComplete_latency_ms()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.complete_latency_ms, typedOther.complete_latency_ms);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
