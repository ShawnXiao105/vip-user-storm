...
public class Grouping extends org.apache.thrift.TUnion<Grouping, Grouping._Fields> {
  ...
  public static Grouping custom_serialized(byte[] value) {
    Grouping x = new Grouping();
    x.setCustom_serialized(ByteBuffer.wrap(value));
    return x;
  }
  ...
  public byte[] getCustom_serialized() {
    ...
    ByteBuffer b = bufferForCustom_serialized();
    return b == null ? null : b.array();
  }

  public ByteBuffer bufferForCustom_serialized() {
  ...
  public void setCustom_serialized(byte[] value) {
    setCustom_serialized(ByteBuffer.wrap(value));
  }

  public void setCustom_serialized(ByteBuffer value) {
    if (value == null) throw new NullPointerException();
