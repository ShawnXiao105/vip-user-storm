...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable {
  ...
  public int wait_secs; // required
  public int num_workers; // required
  public Map<String,Integer> num_executors; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i539 = 0; _i539 < _map538.size; ++_i539)
                {
                  ...
                  int _val541; // required
                  _key540 = iprot.readString();
                  _val541 = iprot.readI32();
                  struct.num_executors.put(_key540, _val541);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i545 = 0; _i545 < _map544.size; ++_i545)
          {
            ...
            int _val547; // required
            _key546 = iprot.readString();
            _val547 = iprot.readI32();
            struct.num_executors.put(_key546, _val547);
          }
        }
        struct.setNum_executorsIsSet(true);
      }
