...
public class LSSupervisorId implements org.apache.thrift.TBase<LSSupervisorId, LSSupervisorId._Fields>, java.io.Serializable, Cloneable {
  ...
  public LSSupervisorId setSupervisor_id(String supervisor_id) {
    this.supervisor_id = supervisor_id;
    return this;
  }
  ...
  public int compareTo(LSSupervisorId other) {
    ...
    LSSupervisorId typedOther = (LSSupervisorId)other;
