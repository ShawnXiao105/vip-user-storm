...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,Double> total_resources; // required
  public double used_mem; // required
  public double used_cpu; // required
  ...
  private _Fields optionals[] = {_Fields.VERSION,_Fields.TOTAL_RESOURCES,_Fields.USED_MEM,_Fields.USED_CPU};
  ...
  public SupervisorSummary(SupervisorSummary other) {
    ...
    if (other.isSetTotal_resources()) {
      Map<String,Double> __this__total_resources = new HashMap<String,Double>();
      for (Map.Entry<String, Double> other_element : other.total_resources.entrySet()) {

        String other_element_key = other_element.getKey();
        Double other_element_value = other_element.getValue();

        String __this__total_resources_copy_key = other_element_key;

        Double __this__total_resources_copy_value = other_element_value;

        __this__total_resources.put(__this__total_resources_copy_key, __this__total_resources_copy_value);
      }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case NUM_USED_WORKERS:
      return Integer.valueOf(getNum_used_workers());
    ...
    case USED_MEM:
      return Double.valueOf(getUsed_mem());

    case USED_CPU:
      return Double.valueOf(getUsed_cpu());
  ...
  public int compareTo(SupervisorSummary other) {
    ...
    lastComparison = Boolean.valueOf(isSetNum_used_workers()).compareTo(typedOther.isSetNum_used_workers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetTotal_resources()).compareTo(typedOther.isSetTotal_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTotal_resources()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.total_resources, typedOther.total_resources);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUsed_mem()).compareTo(typedOther.isSetUsed_mem());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUsed_mem()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.used_mem, typedOther.used_mem);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUsed_cpu()).compareTo(typedOther.isSetUsed_cpu());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUsed_cpu()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.used_cpu, typedOther.used_cpu);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i99 = 0; _i99 < _map98.size; ++_i99)
                {
                  ...
                  double _val101; // required
                  _key100 = iprot.readString();
                  _val101 = iprot.readDouble();
                  struct.total_resources.put(_key100, _val101);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i105 = 0; _i105 < _map104.size; ++_i105)
          {
            ...
            double _val107; // required
            _key106 = iprot.readString();
            _val107 = iprot.readDouble();
            struct.total_resources.put(_key106, _val107);
          }
        }
        struct.setTotal_resourcesIsSet(true);
      }
