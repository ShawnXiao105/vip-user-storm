...
public class GetInfoOptions implements org.apache.thrift.TBase<GetInfoOptions, GetInfoOptions._Fields>, java.io.Serializable, Cloneable {
   ...
   * @see NumErrorsChoice
   */
  public NumErrorsChoice num_err_choice; // required
  ...
  private _Fields optionals[] = {_Fields.NUM_ERR_CHOICE};
  ...
  public int compareTo(GetInfoOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetNum_err_choice()).compareTo(typedOther.isSetNum_err_choice());
    if (lastComparison != 0) {
        ...
        switch (schemeField.id) {
          case 1: // NUM_ERR_CHOICE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.num_err_choice = NumErrorsChoice.findByValue(iprot.readI32());
