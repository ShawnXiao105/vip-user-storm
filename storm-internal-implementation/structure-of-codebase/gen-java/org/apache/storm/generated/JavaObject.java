...
public class JavaObject implements org.apache.thrift.TBase<JavaObject, JavaObject._Fields>, java.io.Serializable, Cloneable {
  ...
  public String full_class_name; // required
  public List<JavaObjectArg> args_list; // required
  ...
  public JavaObject setFull_class_name(String full_class_name) {
    this.full_class_name = full_class_name;
    return this;
  }
  ...
  public List<JavaObjectArg> getArgs_list() {
    return this.args_list;
  }

  public JavaObject setArgs_list(List<JavaObjectArg> args_list) {
    this.args_list = args_list;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FULL_CLASS_NAME:
      if (value == null) {
        ...
        setFull_class_name((String)value);
      }
      break;
    ...
    case ARGS_LIST:
      if (value == null) {
        ...
        setArgs_list((List<JavaObjectArg>)value);
      }
      break;
  ...
  public int compareTo(JavaObject other) {
    ...
    lastComparison = Boolean.valueOf(isSetFull_class_name()).compareTo(typedOther.isSetFull_class_name());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetArgs_list()).compareTo(typedOther.isSetArgs_list());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArgs_list()) {
