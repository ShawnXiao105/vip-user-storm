            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i233 = 0; _i233 < _map232.size; ++_i233)
                {
                  ...
                  struct.acked.put(_key234, _val235);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i249 = 0; _i249 < _map248.size; ++_i249)
                {
                  ...
                  Map<String,Double> _val251; // required
                  _key250 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map252 = iprot.readMapBegin();
                    _val251 = new HashMap<String,Double>(2*_map252.size);
                    for (int _i253 = 0; _i253 < _map252.size; ++_i253)
                    {
                      String _key254; // required
                      double _val255; // required
                      _key254 = iprot.readString();
                      _val255 = iprot.readDouble();
                      _val251.put(_key254, _val255);
                    }
                    iprot.readMapEnd();
                  }
                  struct.complete_ms_avg.put(_key250, _val251);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SpoutStats struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i269 = 0; _i269 < _map268.size; ++_i269)
        {
          ...
          Map<String,Long> _val271; // required
          _key270 = iprot.readString();
          {
            ...
            _val271 = new HashMap<String,Long>(2*_map272.size);
            for (int _i273 = 0; _i273 < _map272.size; ++_i273)
            {
              String _key274; // required
              long _val275; // required
              _key274 = iprot.readString();
              _val275 = iprot.readI64();
              _val271.put(_key274, _val275);
            }
          }
          struct.acked.put(_key270, _val271);
        }
      }
      struct.setAckedIsSet(true);
      {
        ...
        for (int _i277 = 0; _i277 < _map276.size; ++_i277)
        {
          ...
          Map<String,Long> _val279; // required
          _key278 = iprot.readString();
          {
            ...
            _val279 = new HashMap<String,Long>(2*_map280.size);
            for (int _i281 = 0; _i281 < _map280.size; ++_i281)
            {
              String _key282; // required
              long _val283; // required
              _key282 = iprot.readString();
              _val283 = iprot.readI64();
              _val279.put(_key282, _val283);
            }
          }
          struct.failed.put(_key278, _val279);
        }
      }
      struct.setFailedIsSet(true);
      {
        ...
        for (int _i285 = 0; _i285 < _map284.size; ++_i285)
        {
          ...
          Map<String,Double> _val287; // required
