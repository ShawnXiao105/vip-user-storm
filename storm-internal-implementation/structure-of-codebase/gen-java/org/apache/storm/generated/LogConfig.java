...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,LogLevel> named_logger_level; // required
  ...
  private _Fields optionals[] = {_Fields.NAMED_LOGGER_LEVEL};
  ...
  public LogConfig(LogConfig other) {
    if (other.isSetNamed_logger_level()) {
      Map<String,LogLevel> __this__named_logger_level = new HashMap<String,LogLevel>();
  ...
  public void putToNamed_logger_level(String key, LogLevel val) {
  ...
  public Map<String,LogLevel> getNamed_logger_level() {
    return this.named_logger_level;
  }

  public LogConfig setNamed_logger_level(Map<String,LogLevel> named_logger_level) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case NAMED_LOGGER_LEVEL:
      if (value == null) {
        ...
        setNamed_logger_level((Map<String,LogLevel>)value);
      }
      break;
  ...
  public int compareTo(LogConfig other) {
    ...
    LogConfig typedOther = (LogConfig)other;

    lastComparison = Boolean.valueOf(isSetNamed_logger_level()).compareTo(typedOther.isSetNamed_logger_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNamed_logger_level()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.named_logger_level, typedOther.named_logger_level);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i775 = 0; _i775 < _map774.size; ++_i775)
                {
                  String _key776; // required
                  LogLevel _val777; // required
                  _key776 = iprot.readString();
                  _val777 = new LogLevel();
                  _val777.read(iprot);
                  struct.named_logger_level.put(_key776, _val777);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            String _key782; // required
            LogLevel _val783; // required
            _key782 = iprot.readString();
            _val783 = new LogLevel();
            _val783.read(iprot);
            struct.named_logger_level.put(_key782, _val783);
          }
        }
        struct.setNamed_logger_levelIsSet(true);
      }
