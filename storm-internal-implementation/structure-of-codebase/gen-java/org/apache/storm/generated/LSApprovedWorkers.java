...
public class LSApprovedWorkers implements org.apache.thrift.TBase<LSApprovedWorkers, LSApprovedWorkers._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,Integer> approved_workers; // required
  ...
  public LSApprovedWorkers(LSApprovedWorkers other) {
    if (other.isSetApproved_workers()) {
      Map<String,Integer> __this__approved_workers = new HashMap<String,Integer>();
      for (Map.Entry<String, Integer> other_element : other.approved_workers.entrySet()) {

        String other_element_key = other_element.getKey();
        Integer other_element_value = other_element.getValue();

        String __this__approved_workers_copy_key = other_element_key;

        Integer __this__approved_workers_copy_value = other_element_value;

        __this__approved_workers.put(__this__approved_workers_copy_key, __this__approved_workers_copy_value);
      }
  ...
  public void putToApproved_workers(String key, int val) {
  ...
  public Map<String,Integer> getApproved_workers() {
    return this.approved_workers;
  }

  public LSApprovedWorkers setApproved_workers(Map<String,Integer> approved_workers) {
    this.approved_workers = approved_workers;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case APPROVED_WORKERS:
      if (value == null) {
        ...
        setApproved_workers((Map<String,Integer>)value);
      }
      break;
  ...
  public int compareTo(LSApprovedWorkers other) {
    ...
    LSApprovedWorkers typedOther = (LSApprovedWorkers)other;

    lastComparison = Boolean.valueOf(isSetApproved_workers()).compareTo(typedOther.isSetApproved_workers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApproved_workers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.approved_workers, typedOther.approved_workers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  String _key724; // required
                  int _val725; // required
                  _key724 = iprot.readString();
                  _val725 = iprot.readI32();
                  struct.approved_workers.put(_key724, _val725);
                }
                iprot.readMapEnd();
              }
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i729 = 0; _i729 < _map728.size; ++_i729)
        {
          String _key730; // required
          int _val731; // required
          _key730 = iprot.readString();
          _val731 = iprot.readI32();
          struct.approved_workers.put(_key730, _val731);
        }
      }
      struct.setApproved_workersIsSet(true);
    }
