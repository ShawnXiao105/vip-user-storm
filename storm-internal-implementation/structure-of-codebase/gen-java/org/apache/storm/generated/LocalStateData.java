...
public class LocalStateData implements org.apache.thrift.TBase<LocalStateData, LocalStateData._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,ThriftSerializedObject> serialized_parts; // required
  ...
  public LocalStateData(LocalStateData other) {
    if (other.isSetSerialized_parts()) {
      Map<String,ThriftSerializedObject> __this__serialized_parts = new HashMap<String,ThriftSerializedObject>();
  ...
  public void putToSerialized_parts(String key, ThriftSerializedObject val) {
  ...
  public Map<String,ThriftSerializedObject> getSerialized_parts() {
    return this.serialized_parts;
  }

  public LocalStateData setSerialized_parts(Map<String,ThriftSerializedObject> serialized_parts) {
    this.serialized_parts = serialized_parts;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SERIALIZED_PARTS:
      if (value == null) {
        ...
        setSerialized_parts((Map<String,ThriftSerializedObject>)value);
      }
      break;
  ...
  public int compareTo(LocalStateData other) {
    ...
    LocalStateData typedOther = (LocalStateData)other;

    lastComparison = Boolean.valueOf(isSetSerialized_parts()).compareTo(typedOther.isSetSerialized_parts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSerialized_parts()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serialized_parts, typedOther.serialized_parts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i705 = 0; _i705 < _map704.size; ++_i705)
                {
                  ...
                  ThriftSerializedObject _val707; // required
                  _key706 = iprot.readString();
                  _val707 = new ThriftSerializedObject();
                  _val707.read(iprot);
                  struct.serialized_parts.put(_key706, _val707);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i711 = 0; _i711 < _map710.size; ++_i711)
        {
          ...
          ThriftSerializedObject _val713; // required
          _key712 = iprot.readString();
          _val713 = new ThriftSerializedObject();
          _val713.read(iprot);
          struct.serialized_parts.put(_key712, _val713);
        }
      }
      struct.setSerialized_partsIsSet(true);
    }
