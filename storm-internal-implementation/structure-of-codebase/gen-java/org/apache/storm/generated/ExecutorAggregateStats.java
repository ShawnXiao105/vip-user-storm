...
public class ExecutorAggregateStats implements org.apache.thrift.TBase<ExecutorAggregateStats, ExecutorAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public ExecutorSummary exec_summary; // required
  public ComponentAggregateStats stats; // required
  ...
  private _Fields optionals[] = {_Fields.EXEC_SUMMARY,_Fields.STATS};
  ...
  public int compareTo(ExecutorAggregateStats other) {
    ...
    ExecutorAggregateStats typedOther = (ExecutorAggregateStats)other;

    lastComparison = Boolean.valueOf(isSetExec_summary()).compareTo(typedOther.isSetExec_summary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExec_summary()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.exec_summary, typedOther.exec_summary);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
